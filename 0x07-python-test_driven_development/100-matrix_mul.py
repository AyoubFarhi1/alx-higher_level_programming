...
def matrix_mul(m_a, m_b):
    ...
    Raises:
        TypeError: If input matrices are not lists of lists,
                   or contain elements that are not integers or floats,
                   or if the matrices cannot be multiplied.
        ValueError: If input matrices are empty or contain rows of different sizes.
    """
    # Input validation
